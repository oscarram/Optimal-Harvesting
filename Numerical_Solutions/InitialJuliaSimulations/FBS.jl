...
plot(harvest, linewidth=2, xaxis="Time (t)", yaxis="Number of fishes per time unit", label="Fish Harvest rate")
plot(solX, linewidth=2, xaxis="Time (t)", yaxis="Number of fishes", label="Population")
Nfishes(t)=harvest(t)
quadgk(Nfishes, 0, TH)
