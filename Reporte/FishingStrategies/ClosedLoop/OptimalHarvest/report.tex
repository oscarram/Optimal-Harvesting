...
\begin{table}[H]
	...
	\begin{tabular}{@{}l|r@{}}
		...
		$ \bar{p}^*$& 3.75852278721341                                                                                    \\
		\rowcolor[HTML]{E2F7E2} 
		$\bar{p}^*-0.001$             & 3.75851040206431                                                                                \\
		\rowcolor[HTML]{E2F7E2} 
		$\bar{p}^*+0.001$             & 3.75851041124381                                                                                  \\
		\rowcolor[HTML]{E2F7E2} 
		$\bar{p}^*-0.01$              & 
		3.75728167320450 \\
		\rowcolor[HTML]{E2F7E2} 
		$\bar{p}^*+0.01$              & 3.75728788234568                                                                                   \\
		\rowcolor[HTML]{E2F7E2} 
		$\bar{p}^*-0.1$               & 3.63201762222214 \\
		\rowcolor[HTML]{E2F7E2} 
		$\bar{p}^*+0.1$               & 3.63833452009445 \\ \bottomrule
	\end{tabular}
